...
$CategoryName=$_POST['name'];
     ...
     if (mysqli_query($conn, $query))
     {
       ...
       echo "<script> alert('Category Added Successfully');window.location.href = 'viewcat.php';</script>";
     ...
     else 
     {
       ...
       echo "<script> alert('Error Please Try Again');window.location.href = 'viewcat.php';</script>";
     }
