...
$featured=$_POST['featured'];
     ...
     $query="INSERT INTO product(category_id,subcategory_id,product_code,product_name,featured,price) VALUES ('$cate','$subcate','$code','$Name','$featured','$price')";
     ...
     if (mysqli_query($conn, $query))
     {
       ...
       echo "<script> alert('Product Added Successfully');window.location.href = 'viewprod.php';</script>";
     ...
     else 
     {
       ...
       echo "<script> alert('Error Please Try Again');window.location.href = 'viewprod.php';</script>";
     }
...
<div class="form-group"><label class="col-sm-2 control-label">Category</label>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Sub Category</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <select name="subcate" class="form-control">
                                            <?php
                                            $result1     = mysqli_query($conn,"SELECT * from sub_category");
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Product Code</label>
                                    ...
                                    <div class="col-sm-10"><select name="featured" class="form-control">
                                        <option value="0"> NO
                               ...
                               <!-- <div class="form-group"><label class="col-sm-2 control-label">Image</label>
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="ProductImage" class="form-control " name="ProductImage" placeholder="Product Image" type="file">
                                    </div>
                                </div>-->
